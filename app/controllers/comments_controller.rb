class CommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comment.save
        ...
        format.json { render :show, status: :created, location: @comment.event }
      else
  ...
  def destroy
    if current_user == @comment.user
      ...
      respond_to do |format|
        format.html { redirect_to @comment.event, notice: 'No tienes permisos para realizar esta acción' }
        format.json { head :no_content }
      end
    end
  end
